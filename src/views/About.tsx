    ...
    <main className="main one about">
      ...
      <section className="sec">
        ...
        <ol className="how">
          ...
          <li><b>Workforce.</b> Every month, expected attrition comes off the team; hires land after their lead time; reallocations move people between teams. There is no automatic backfill.</li>
